...
const StaffSchema = new mongoose.Schema(
  {
    ...
    employmentType: { type: String, enum: ['full_time','part_time','freelance'], default: 'full_time' },
...
export default mongoose.models.staffModel || mongoose.model('StaffModel', StaffSchema);